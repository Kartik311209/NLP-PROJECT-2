...
-----------------------------
train_texts = [ {"text": "Hello, I am fine-tuning."}, {"text": "This is another example."} ]

def tokenize(batch): return tokenizer(batch["text"], truncation=True)

dataset = Dataset.from_list(train_texts) tokenized_ds = dataset.map(tokenize)

-----------------------------
3. Training Arguments
-----------------------------
training_args = TrainingArguments( output_dir="./finetuned_llama", per_device_train_batch_size=1, num_train_epochs=1, logging_steps=10, save_steps=50, )
...
5. Save Final Model
-----------------------------
trainer.save_model("./finetuned_llama") print("Training Completed & Model Saved!")
